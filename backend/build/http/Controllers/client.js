...
async function postClient(request, reply) {
  const createClientBodySchema = import_zod2.z.object({
    legalName: import_zod2.z.string().min(1),
    tradeName: import_zod2.z.string().min(1),
    type: import_zod2.z.number().min(1),
    protocol: import_zod2.z.string().min(11).max(15),
    dataFundation: import_zod2.z.coerce.date(),
    locationAddress: import_zod2.z.string().min(1),
    correspondenceAddress: import_zod2.z.string().min(1),
    nameContact: import_zod2.z.string().min(1),
    numberContact: import_zod2.z.string().min(1),
    isActivated: import_zod2.z.boolean()
  });
  const {
    legalName,
    tradeName,
...
async function updateClient(request, reply) {
  const updateClientBodySchema = import_zod2.z.object({
    ...
    tradeName: import_zod2.z.string().optional(),
    type: import_zod2.z.number().optional(),
    protocol: import_zod2.z.string().optional(),
    dataFundation: import_zod2.z.coerce.date().optional(),
    locationAddress: import_zod2.z.string().optional(),
    correspondenceAddress: import_zod2.z.string().optional(),
    nameContact: import_zod2.z.string().optional(),
    numberContact: import_zod2.z.string().optional(),
    isActivated: import_zod2.z.boolean().optional(),
    responsibleById: import_zod2.z.string().optional()
  });
  const { id } = request.params;
